...
class PGAgent(nn.Module):
    ...
    def train(self,states,actions,rewards,next_states,dones):
        ...
        next_states=torch.stack(next_states).to(self.device)#(B,4)
        ...
        for episode in range(config['episode']):
            ...
            if episode % 20 == 0:
                ...
                if avg_reward > agent.best_avg_reward:
                    ...
                    agent.save_model(path_actor=f"./A2C_output/best_actor.pth",path_critic=f"./A2C_output/best_critic.pth")
                    agent.best_avg_reward = avg_reward
...
test_env=OneDNavigationEnv()
best_actor_path = "./A2C_output/best_actor.pth"  
best_critic_path = "./A2C_output/best_critic.pth"
